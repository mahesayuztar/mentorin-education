...
<div class="cardBox">
    <a href="{{ url('/category/cpns/skb-cpns/psikologi-cpns/tes-kecerdasan') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/category/cpns/skb-cpns/psikologi-cpns/tes-kecermatan') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/category/cpns/skb-cpns/psikologi-cpns/tes-kepribadian') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
