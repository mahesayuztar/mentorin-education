...
<div class="cardBox">
    <a href="{{ url('/category/cpns/lainnya-cpns/praktek-kerja') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
                <h2 style="cursor: pointer;">TES SKB CAT</h2>
                <p style="margin-top: 0.5rem; cursor: pointer;">Ujian seleksi kompetensi berbasis komputer untuk calon pegawai di instansi pemerintah.</p>
