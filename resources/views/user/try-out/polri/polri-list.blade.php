...
<div class="cardBox">
    ...
    <a href="{{ url('/try-out/polri/PSI') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/try-out/polri/AKA') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/try-out/polri/LAI') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
