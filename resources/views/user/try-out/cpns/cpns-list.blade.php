...
<div class="cardBox">
    ...
    <a href="{{ url('/try-out/cpns/skd-cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/try-out/cpns/skb-cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/try-out/cpns/lainnya-cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
