...
<div class="cardBox">
    <a href="{{ url('/exercise/cpns/skb-cpns/cat-cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/exercise/cpns/skb-cpns/cat-sekdin') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    {{-- <a href="{{ url('/exercise/cpns/skb-cpns/psikologi-cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/exercise/cpns/skb-cpns/praktek-kerja') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
