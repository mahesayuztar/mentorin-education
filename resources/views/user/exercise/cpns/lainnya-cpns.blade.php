...
<div class="cardBox">
    <a href="{{ url('/exercise/cpns/lainnya-cpns/akademik-cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/exercise/cpns/lainnya-cpns/psikotes-cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
                <h2 style="cursor: pointer;">TES PSIKOTES</h2>
                <p style="margin-top: 0.5rem; margin-bottom: 1rem; cursor: pointer;">Berisi berbagai jenis Latihan Soal mulai dari tes kecerdasan, kecermatan dan kepribadian</p>
                <img src="{{ asset('user/img/icon/psikologi.png') }}" width="150" height="150">
            </div>
        </div>
    </a>

    <a href="{{ url('/exercise/cpns/lainnya-cpns/praktek-kerja') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
