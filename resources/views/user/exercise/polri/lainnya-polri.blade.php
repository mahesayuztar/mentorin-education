...
<div class="cardBox">
    <a href="{{ url('/exercise/polri/lainnya-polri/tes-kesamaptaan-jasmani') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/exercise/polri/lainnya-polri/tes-pmk') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
