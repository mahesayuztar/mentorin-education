...
@section('content')
{{-- cards --}}
<h1 class="card-title">Try Out yang Sudah Ditambahkan</h1>

<div class="cardBox">
    
@if($tampil->contains('POL'))
    <a href="{{ url('/try-out/polri') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
...
@if($tampil->contains('PNS'))
 <a href="{{ url('/try-out/cpns') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
                <h2 style="cursor: pointer;">Try Out</h2>
