...
<div class="cardBox">
    <a href="{{ url('/category/polri/psikologi-polri/tes-pass-hand') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/category/polri/psikologi-polri/tes-kecerdasan') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/category/polri/psikologi-polri/tes-kepribadian') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/category/polri/psikologi-polri/tes-kecermatan') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
    ...
    <a href="{{ url('/category/polri/psikologi-polri/paket-tes-polri') }}" style="text-decoration: none; color: #001e26;">
        <div class="card">
            <div>
