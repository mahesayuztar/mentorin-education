...
<div class="cardBox">
    <a href="{{ url('/category/polri/akademik-polri/tes-pengetahuan-umum') }}" style="text-decoration: none; color: #001e26;">
    ...
    <a href="{{ url('/category/polri/akademik-polri/tes-penalaran-numerik') }}" style="text-decoration: none; color: #001e26;">
        <div class="card akademik">
            <div>
    ...
    <a href="{{ url('/category/polri/akademik-polri/tes-wawasan-kebangsaan') }}" style="text-decoration: none; color: #001e26;">
        <div class="card akademik">
            <div>
    ...
    <a href="{{ url('/category/polri/akademik-polri/tes-bahasa-inggris') }}" style="text-decoration: none; color: #001e26;">
        <div class="card akademik">
            <div>
    ...
    <a href="{{ url('/category/polri/akademik-polri/tes-potensi-akademik') }}" style="text-decoration: none; color: #001e26;">
        <div class="card akademik">
            <div>
    ...
    <a href="{{ url('/category/polri/akademik-polri/tes-bahasa-indonesia') }}" style="text-decoration: none; color: #001e26;">
        <div class="card akademik">
            <div>
