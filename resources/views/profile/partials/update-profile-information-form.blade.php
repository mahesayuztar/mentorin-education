<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="photo_profile" name="photo_profile" type="file" class="mt-1 block w-full" onchange="previewImage(event)" />
        ...
        <div class="flex items-center gap-4">
            <x-danger-button><a href="{{ url('dashboard') }}">{{ __('Kembali') }}</a></x-danger-button>
